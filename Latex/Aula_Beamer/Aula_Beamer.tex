...
%\subtitle{Preliminar e Incompleto. Comentários e sugestões são bem-vindos!}


\author[Besarria(2017)]{Cássio da Nóbrega Besarria }
...
\begin{itemize}	
	\pause \item Para avaliar ou comparar políticas alternativas é preciso estabelecer um critério. 
	\pause \item Objetivo Único? Utilidade.
	\pause \item Qual Utilidade? Instântanea (consumo, lazer),
...
\begin{frame}[label=myslide4.1] % [<options>=label, plain, (c=center,t=top,b=bottom)]
	...
	\frametitle{Restrição orçamentária do governo} {\ % <= Be careful with this!
...
\begin{frame}[label=myslide14] % [<options>=label, plain, (c=center,t=top,b=bottom)]
	...
	\frametitle{Equidade} {\ % <= Be careful with this!
		...
		Distribuição do ônus tributário deve ser equitativa entre os indivíduos da sociedade (cada indivíduo deve contribuir com uma parcela 'justa' para cobrir os custos do governo). \\ \vspace{1cm}
		
		\textbf{Princípio}: Cada indivíduo deveria contribuir
		com uma quantidade proporcional aos benefícios gerados
		pelo consumo do bem público (dificuldade: estabelecer uma
		regra geral – indivíduos não declaram o valor dado ao
		benefício); 
